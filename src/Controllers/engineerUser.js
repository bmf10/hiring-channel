...
module.exports = {
    ...
    postSkill: (req, res) => {
        ...
        const token = req.headers['authorization'];
        const decoded = jwtdecode(token);
        model.postSkill(body, decoded['id']).then(response => {
            const data = {
    ...
    patchSkill: (req, res) => {
        ...
        const token = req.headers['authorization'];
        const decoded = jwtdecode(token);
        model.patchSkill(params, query, decoded['id']).then(response => {
            const data = query;
            const msg = 'success';
            form.success(res, data, msg);
        }).catch(err => console.log(err))
    ...
    deleteSkill: (req, res) => {
        ...
        const token = req.headers['authorization'];
        const decoded = jwtdecode(token);
        model.deleteSkill(params, decoded['id']).then(response => {
            const data = {
                description: "Deleted"
            };
            const msg = 'success';
    ...
    postShowcase: (req, res) => {
        ...
        const token = req.headers['authorization'];
        const decoded = jwtdecode(token);
        model.postShowcase(body, decoded['id']).then(response => {
            const data = {
                id: response.insertId,
    ...
    patchShowcase: (req, res) => {
        ...
        const token = req.headers['authorization'];
        const decoded = jwtdecode(token);
        model.patchShowcase(params, query, decoded['id']).then(response => {
            const data = query;
            const msg = 'success';
            form.success(res, data, msg);
        }).catch(err => console.log(err))
    ...
    deleteShowcase: (req, res) => {
        ...
        const token = req.headers['authorization'];
        const decoded = jwtdecode(token);
        model.deleteShowcase(params, decoded['id']).then(response => {
            const data = {
                description: "Deleted"
            };
            const msg = 'success';
